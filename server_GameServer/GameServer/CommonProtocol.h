...
enum en_PACKET_TYPE
{
	...
	// }
	//------------------------------------------------------
	en_PACKET_SS_CHATSERVER_LOGIN,

	//------------------------------------------------------
	// 게임 서버에서 채팅서버로 유저가 들어왔음을 알림
	// 
	// {
	//		uint16_t	Type
	//		uint64_t	sessionId
	...
	//		uint32_t	ChatServerNo
	//		uint32_t	GameServerNo
	// }
	//------------------------------------------------------
	en_PACKET_SS_NEW_USER_REQUEST,

	//------------------------------------------------------
	// 채팅 서버에서 게임서버가 보낸 REQUEST와 
	// 본인이 클라에게 받은 정보를 비교해서 동일 인물이 
	// 양쪽에 로그인 된게 확인되면, 로그인을 진행하라고 보냄
	// 이걸 받은 서버는 실패 시 그 해당 유저 킥
	// {
	//		uint16_t	Type
	//		uint64_t	sessionId
	//		int64_t		AccountNo
	//		uint64_t	SequenceNum
	//		int8_t		Success (0: 실패 1: 성공)
	// }
	//------------------------------------------------------
	en_PACKET_SS_NEW_USER_RESPONSE,

	//------------------------------------------------------
	// 게임 서버에서 특정 유저가 나갔다고 채팅 서버에 보냄
	// {
	//		uint16_t	Type
	//		int64_t		AccountNo
	//		uint64_t	SequenceNum
